...
Thirteen papers. One architecture. The repo is the agent. The seed becomes the application.
...
| 10 | **Mesh Fleet** | Sovereign nodes, no center, auto-scales by replication | [become-ai/docs/MESH-FLEET.md](https://github.com/Lucineer/become-ai/blob/master/docs/MESH-FLEET.md) |
| 11 | **Bootcamp Architecture** | Captain-to-cocapn: agent becomes the app | [Lucineer/become-ai](https://github.com/Lucineer/become-ai) |
| 12 | **The Seed** | One repo to become them all | [Lucineer/the-seed](https://github.com/Lucineer/the-seed) |
| 13 | **Nexus RA** | 19-year edge intelligence backcast | [Lucineer/nexus-git-agent](https://github.com/Lucineer/nexus-git-agent) |
